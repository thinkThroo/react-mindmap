...
var Topic = /** @class */ (function (_super) {
    ...
    Topic.fromJSON = function (obj) {
        debugger;
        var key = obj.key, _a = obj.parentKey, parentKey = _a === void 0 ? null : _a, blocks = obj.blocks, _b = obj.subKeys, subKeys = _b === void 0 ? [] : _b, _c = obj.collapse, collapse = _c === void 0 ? false : _c, task_id = obj.task_id;
        return new Topic({
            key: key,
            parentKey: parentKey,
            collapse: collapse,
        ...
        model = model.withMutations(function (model) {
            topics.forEach(function (topic) {
                model.update('topics', function (topics) {
                    debugger;
                    console.log("inside model fromJSON", object, "check topic's task_id");
