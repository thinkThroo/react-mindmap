...
var Topic = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Topic.prototype, "properties", {
        get: function () {
    ...
    Topic.fromJSON = function (obj) {
        debugger;
        var key = obj.key, _a = obj.parentKey, parentKey = _a === void 0 ? null : _a, blocks = obj.blocks, _b = obj.subKeys, subKeys = _b === void 0 ? [] : _b, _c = obj.collapse, collapse = _c === void 0 ? false : _c, task_id = obj.task_id, properties = obj.properties;
        return new Topic({
            key: key,
            parentKey: parentKey,
            collapse: collapse,
    ...
    Topic.create = function (_a) {
        var key = _a.key, _b = _a.parentKey, parentKey = _b === void 0 ? null : _b, _c = _a.content, content = _c === void 0 ? '' : _c, _d = _a.subKeys, subKeys = _d === void 0 ? [] : _d, _e = _a.collapse, collapse = _e === void 0 ? false : _e, properties = _a.properties;
        ...
        console.log("about to create new topic::with content::", content);
        return new Topic({
            key: key,
            parentKey: parentKey,
            blocks: blocks,
...
function focusTopic(_a) {
    ...
    log$1('focus topic');
    debugger;
    console.log("inside focusTopic function");
...
function setFocusMode(_a) {
    ...
    log$1('setFocusMode');
    console.log("inside setFocusMode function");
    debugger;
    if (focusMode !== model.focusMode)
        model = model.set('focusMode', focusMode);
    return model;
...
function addChild(_a) {
    ...
    console.log("about to add child node");
    debugger;
    var topic = model.getTopic(topicKey);
    if (topic) {
...
function setProperties(_a) {
    var model = _a.model, topicKey = _a.topicKey, properties = _a.properties;
    var topic = model.getTopic(topicKey);
    if (topic) {
        console.log("model before", model);
        model = model.updateIn(['topics', topicKey, 'properties'], function (p) { return properties; });
        console.log("model after update", model);
        console.log("model::", model, "found topic-> is this updated though?");
    }
    return model;
}
        ...
        model = model.withMutations(function (model) {
            topics.forEach(function (topic) {
                model.update('topics', function (topics) {
                    // debugger;
                    console.log("Topic in model/withMutations func::", topic);
...
export { Block, BlockType, Config, Controller, DiagramLayoutType, FocusMode, Model, modifiers as ModelModifier, modifiers as Modifiers, OpType, Topic, TopicDirection, TopicRelationship, TopicVisualLevel, createKey, defaultTheme, getAllSubTopicKeys, getKeyPath, getRelationship, isThemeType };
